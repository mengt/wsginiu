...
class SecureController(BaseController):
    ...
    print 'SecureController:The predicate that must be met for all the actions in this controller'
    allow_only = has_permission('manage',
                                msg=l_('Only for people with the "manage" permission'))
    
    @expose('wsginiu.templates.index')
    def index(self):
        print 'Let the user know thats visiting a protected controller.'
    ...
    @expose('wsginiu.templates.index')
    def some_where(self):
        print 'Let the user know that this action is protected too.'
